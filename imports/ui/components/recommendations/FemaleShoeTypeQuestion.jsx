...
export default class FemaleShoeTypeQuestion extends Component {
  renderGrids() {
    let grids = [];
    let pictureIndex = 0;
        ...
        <GridTile
          ...
          actionIcon={<IconButton><StarBorder color="red" /></IconButton>}>
            <img
              ...
              onClick={this.props.handleFemaleShoeTypeChange}/>
        </GridTile>
      );
      pictureIndex++;
    }
...
FemaleShoeTypeQuestion.propTypes = {
  handleFemaleShoeTypeChange: React.PropTypes.func.isRequired
}